...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[1514,0,231,410],[1514,600,57,92],[1514,412,58,92],[1514,506,58,92],[1514,694,54,92],[0,0,1512,2016]]}
];
...
// stage content:
(lib.LAB81 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance_1.setTransform(286.65,351.9,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(60));

	// V
	this.instance_2 = new lib.CachedBmp_4();
	this.instance_2.setTransform(353.65,364.9,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(60));

	// E
	this.instance_3 = new lib.CachedBmp_5();
	this.instance_3.setTransform(416.8,338.9,0.5,0.5);
	...
	this.instance_4.setTransform(346.7,299.3);

	this.instance_5 = new lib.Pic();
	this.instance_5.setTransform(346.7,225,1,1,0,0,0,161.7,209);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_4}]}).to({state:[{t:this.instance_5}]},39).wait(21));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({_off:true,regX:161.7,regY:209,y:225,mode:"independent"},39).wait(21));
